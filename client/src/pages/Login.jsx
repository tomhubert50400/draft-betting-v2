  ...
  return (
    <div className="flex items-center justify-center py-20">
      <div className="bg-bg-card rounded-2xl border border-white/5 p-8 max-w-sm w-full text-center">
        <h1 className="text-2xl font-bold bg-gradient-accent bg-clip-text text-transparent mb-2">
          Draft Betting
        </h1>
        ...
        <a
          href={discordUrl}
          className="inline-flex items-center justify-center gap-3 w-full px-6 py-3 rounded-xl font-semibold text-white text-sm transition-all hover:opacity-90 hover:shadow-lg"
